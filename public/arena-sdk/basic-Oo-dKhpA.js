import { i as P, e as M, r as A, a as I, x as c, C as L, A as T, O as Y, b as E, E as J, R as O, c as ke, d as D, f as S, S as ft, g as Hi, W as gt, h as jt, j as si, T as kt, k as Qe, M as vi, l as yi, m as Ae, n as li, o as Ki } from "./core-DT8g9mFm.js";
import { n as u, c as C, o as y, r as v, U as se, e as Gi, f as Yi, a as Ji } from "./index-COHlrcSf.js";
const Qi = P`
  :host {
    position: relative;
...
let Xe = class extends I {
  ...
  render() {
    ...
    return c`${this.walletImages.slice(0, Wt).map(({ src: i, walletName: n }) => c`
            <wui-wallet-image
              size="inherit"
              imageSrc=${i}
              name=${y(n)}
...
let we = class extends I {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = L.state.connectors, this.count = T.state.count, this.filteredCount = T.state.filteredWallets.length, this.isFetchingRecommendedWallets = T.state.isFetchingRecommendedWallets, this.unsubscribe.push(L.subscribeKey("connectors", (e) => this.connectors = e), T.subscribeKey("count", (e) => this.count = e), T.subscribeKey("filteredWallets", (e) => this.filteredCount = e.length), T.subscribeKey("isFetchingRecommendedWallets", (e) => this.isFetchingRecommendedWallets = e));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  render() {
    const e = this.connectors.find((l) => l.id === "walletConnect"), { allWallets: i } = Y.state;
    if (!e || i === "HIDE" || i === "ONLY_MOBILE" && !E.isMobile())
      return null;
    const n = T.state.featured.length, o = this.count + n, t = o < 10 ? o : Math.floor(o / 10) * 10, a = this.filteredCount > 0 ? this.filteredCount : t;
    let s = `${a}`;
  ...
  onAllWallets() {
    J.sendEvent({ type: "track", event: "CLICK_ALL_WALLETS" }), O.push("AllWallets");
  }
};
Pe([
  u()
...
let Ze = class extends I {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = L.state.connectors, this.unsubscribe.push(L.subscribeKey("connectors", (e) => this.connectors = e));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  onConnector(e) {
    e.id === "walletConnect" ? E.isMobile() ? O.push("AllWallets") : O.push("ConnectingWalletConnect") : O.push("ConnectingExternal", { connector: e });
  }
};
Kt([
  u()
...
let ze = class extends I {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = L.state.connectors, this.loading = !1, this.unsubscribe.push(L.subscribeKey("connectors", (e) => this.connectors = e)), E.isTelegram() && E.isIos() && (this.loading = !S.state.wcUri, this.unsubscribe.push(S.subscribeKey("wcUri", (e) => this.loading = !e)));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  filterOutDuplicateWallets(e) {
    ...
    if (t.includes("io.metamask.mobile") && E.isMobile()) {
  ...
  onConnectWallet(e) {
    this.loading || O.push("ConnectingWalletConnect", { wallet: e });
  }
};
wt([
  u()
...
let et = class extends I {
  ...
  render() {
    const n = this.connectors.filter((o) => o.type === "EXTERNAL").filter(ke.showConnector).filter((o) => o.id !== Hi.CONNECTOR_ID.COINBASE_SDK);
  ...
  onConnector(e) {
    O.push("ConnectingExternal", { connector: e });
  }
};
Gt([
  u()
...
let it = class extends I {
  ...
  render() {
    const e = this.connectors.filter(ke.showConnector);
  ...
  onConnector(e) {
    L.setActiveConnector(e), O.push("ConnectingExternal", { connector: e });
  }
};
Jt([
  u()
...
let nt = class extends I {
  ...
  onConnector(e) {
    L.setActiveConnector(e), O.push("ConnectingMultiChain");
  }
};
Qt([
  u()
...
let De = class extends I {
  ...
  render() {
    const i = ft.getRecentWallets().filter((n) => !gt.isExcluded(n)).filter((n) => !this.hasWalletConnector(n)).filter((n) => this.isWalletCompatibleWithCurrentChain(n));
    return i.length ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${i.map((n) => c`
            <wui-list-wallet
...
bt([
  v()
], De.prototype, "connectors", void 0);
bt([
  v()
], De.prototype, "loading", void 0);
De = bt([
  C("w3m-connect-recent-widget")
], De);
...
let Ne = class extends I {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.wallets = [], this.loading = !1, E.isTelegram() && E.isIos() && (this.loading = !S.state.wcUri, this.unsubscribe.push(S.subscribeKey("wcUri", (e) => this.loading = !e)));
  }
  render() {
    const { connectors: e } = L.state, { customWallets: i, featuredWalletIds: n } = Y.state, o = ft.getRecentWallets(), t = e.find((_) => _.id === "walletConnect"), s = e.filter((_) => _.type === "INJECTED" || _.type === "ANNOUNCED" || _.type === "MULTI_CHAIN").filter((_) => _.name !== "Browser Wallet");
    if (!t)
      return null;
    if (n || i || !this.wallets.length)
      return this.style.cssText = "display: none", null;
    const l = s.length + o.length, h = Math.max(0, 2 - l), d = gt.filterOutDuplicateWallets(this.wallets).slice(0, h);
    return d.length ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${d.map((_) => c`
            <wui-list-wallet
  ...
  onConnectWallet(e) {
    if (this.loading)
      return;
    const i = L.getConnector(e.id, e.rdns);
    i ? O.push("ConnectingExternal", { connector: i }) : O.push("ConnectingWalletConnect", { wallet: e });
  }
};
mt([
  u()
...
mt([
  u()
], Ne.prototype, "wallets", void 0);
mt([
  v()
], Ne.prototype, "loading", void 0);
Ne = mt([
  C("w3m-connect-recommended-widget")
], Ne);
...
let Me = class extends I {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = L.state.connectors, this.connectorImages = si.state.connectorImages, this.unsubscribe.push(L.subscribeKey("connectors", (e) => this.connectors = e), si.subscribeKey("connectorImages", (e) => this.connectorImages = e));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  onConnector(e) {
    L.setActiveConnector(e), O.push("ConnectingWalletConnect");
  }
};
vt([
  u()
...
Me = vt([
  C("w3m-connect-walletconnect-widget")
], Me);
const en = P`
  :host {
...
let be = class extends I {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = L.state.connectors, this.recommended = T.state.recommended, this.featured = T.state.featured, this.unsubscribe.push(L.subscribeKey("connectors", (e) => this.connectors = e), T.subscribeKey("recommended", (e) => this.recommended = e), T.subscribeKey("featured", (e) => this.featured = e));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  connectorListTemplate() {
    const { custom: e, recent: i, announced: n, injected: o, multiChain: t, recommended: a, featured: s, external: l } = ke.getConnectorsByType(this.connectors, this.recommended, this.featured);
    return ke.getConnectorTypeOrder({
      custom: e,
      recent: i,
      announced: n,
      injected: o,
...
xt([
  u()
], Re.prototype, "buttonLabel", void 0);
Re = xt([
  C("wui-cta-button")
], Re);
const un = P`
...
let at = class extends I {
  ...
  render() {
    ...
    const { name: e, app_store: i, play_store: n, chrome_store: o, homepage: t } = this.wallet, a = E.isMobile(), s = E.isIos(), l = E.isAndroid(), h = [i, n, t, o].filter(Boolean).length > 1, d = se.getTruncateString({
      string: e,
      charsStart: 12,
      charsEnd: 0,
      truncate: "end"
  ...
  onAppStore() {
    var e;
    (e = this.wallet) != null && e.app_store && E.openHref(this.wallet.app_store, "_blank");
  }
  onPlayStore() {
    var e;
    (e = this.wallet) != null && e.play_store && E.openHref(this.wallet.play_store, "_blank");
  }
  onHomePage() {
    var e;
    (e = this.wallet) != null && e.homepage && E.openHref(this.wallet.homepage, "_blank");
  }
};
at.styles = [un];
$i([
...
class z extends I {
  constructor() {
    var e, i, n, o, t;
    super(), this.wallet = (e = O.state.data) == null ? void 0 : e.wallet, this.connector = (i = O.state.data) == null ? void 0 : i.connector, this.timeout = void 0, this.secondaryBtnIcon = "refresh", this.onConnect = void 0, this.onRender = void 0, this.onAutoConnect = void 0, this.isWalletConnect = !0, this.unsubscribe = [], this.imageSrc = D.getWalletImage(this.wallet) ?? D.getConnectorImage(this.connector), this.name = ((n = this.wallet) == null ? void 0 : n.name) ?? ((o = this.connector) == null ? void 0 : o.name) ?? "Wallet", this.isRetrying = !1, this.uri = S.state.wcUri, this.error = S.state.wcError, this.ready = !1, this.showRetry = !1, this.secondaryBtnLabel = "Try again", this.secondaryLabel = "Accept connection request in the wallet", this.isLoading = !1, this.isMobile = !1, this.onRetry = void 0, this.unsubscribe.push(S.subscribeKey("wcUri", (a) => {
      var s;
      this.uri = a, this.isRetrying && this.onRetry && (this.isRetrying = !1, (s = this.onConnect) == null || s.call(this));
    }), S.subscribeKey("wcError", (a) => this.error = a)), (E.isTelegram() || E.isSafari()) && E.isIos() && S.state.wcUri && ((t = this.onConnect) == null || t.call(this));
  }
  firstUpdated() {
    var e;
  ...
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e()), S.setWcError(!1), clearTimeout(this.timeout);
  }
  render() {
    var n;
  ...
  onTryAgain() {
    var e, i;
    S.setWcError(!1), this.onRetry ? (this.isRetrying = !0, (e = this.onRetry) == null || e.call(this)) : (i = this.onConnect) == null || i.call(this);
  }
  loaderTemplate() {
    const e = kt.state.themeVariables["--w3m-border-radius-master"], i = e ? parseInt(e.replace("px", ""), 10) : 4;
    return c`<wui-loading-thumbnail radius=${i * 9}></wui-loading-thumbnail>`;
  }
  onCopyUri() {
    try {
      this.uri && (E.copyToClopboard(this.uri), Qe.showSuccess("Link copied"));
    } catch {
...
let ui = class extends z {
  constructor() {
    ...
    this.onConnect = this.onConnectProxy.bind(this), this.onAutoConnect = this.onConnectProxy.bind(this), J.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
  ...
  async onConnectProxy() {
    ...
    try {
      this.error = !1;
      const { connectors: i } = L.state, n = i.find((o) => {
        var t, a, s;
...
let di = class extends z {
  constructor() {
    ...
    this.onConnect = this.onConnectProxy.bind(this), this.onRender = this.onRenderProxy.bind(this), J.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
  ...
  onConnectProxy() {
    ...
    if ((e = this.wallet) != null && e.desktop_link && this.uri)
      try {
        this.error = !1;
        const { desktop_link: i, name: n } = this.wallet, { redirect: o, href: t } = E.formatNativeUrl(i, this.uri);
        S.setWcLinking({ name: n, href: t }), S.setRecentWallet(this.wallet), E.openHref(o, "_blank");
      } catch {
        this.error = !0;
      }
  }
...
let me = class extends z {
  constructor() {
    if (super(), this.btnLabelTimeout = void 0, this.redirectDeeplink = void 0, this.redirectUniversalLink = void 0, this.target = void 0, this.preferUniversalLinks = Y.state.experimental_preferUniversalLinks, this.isLoading = !0, this.onConnect = () => {
      ...
      if ((e = this.wallet) != null && e.mobile_link && this.uri)
        try {
          this.error = !1;
          const { mobile_link: i, link_mode: n, name: o } = this.wallet, { redirect: t, redirectUniversalLink: a, href: s } = E.formatNativeUrl(i, this.uri, n);
          this.redirectDeeplink = t, this.redirectUniversalLink = a, this.target = E.isIframe() ? "_top" : "_self", S.setWcLinking({ name: o, href: s }), S.setRecentWallet(this.wallet), this.preferUniversalLinks && this.redirectUniversalLink ? E.openHref(this.redirectUniversalLink, this.target) : E.openHref(this.redirectDeeplink, this.target);
        } catch (i) {
          J.sendEvent({
            type: "track",
    ...
    this.secondaryBtnLabel = "Open", this.secondaryLabel = yi.CONNECT_LABELS.MOBILE, this.secondaryBtnIcon = "externalLink", this.onHandleURI(), this.unsubscribe.push(S.subscribeKey("wcUri", () => {
      this.onHandleURI();
    })), J.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
  ...
  onTryAgain() {
    var e;
    S.setWcError(!1), (e = this.onConnect) == null || e.call(this);
  }
};
Le([
  v()
...
V.getSymbolSize = function(e) {
  if (!e) throw new Error('"version" cannot be null or undefined');
  if (e < 1 || e > 40) throw new Error('"version" should be in range from 1 to 40');
  return e * 4 + 17;
};
V.getSymbolTotalCodewords = function(e) {
  return gn[e];
};
V.getBCHDigit = function(r) {
  let e = 0;
  for (; r !== 0; )
    e++, r >>>= 1;
  return e;
};
V.setToSJISFunction = function(e) {
...
var Si = {}, Rt = {};
const je = new Uint8Array(512), st = new Uint8Array(256);
(function() {
  let e = 1;
  for (let i = 0; i < 255; i++)
    je[i] = e, st[e] = i, e <<= 1, e & 256 && (e ^= 285);
...
Ue = Ue.replace(/u/g, "\\u");
const xn = "(?:(?![A-Z0-9 $%*+\\-./:]|" + Ue + `)(?:.|[\r
]))+`;
ne.KANJI = new RegExp(Ue, "g");
ne.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
ne.BYTE = new RegExp(xn, "g");
ne.NUMERIC = new RegExp(Li, "g");
ne.ALPHANUMERIC = new RegExp(yn, "g");
const Cn = new RegExp("^" + Ue + "$"), $n = new RegExp("^" + Li + "$"), Rn = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function(r) {
  const e = V, i = $t, n = Ct, o = ge, t = ti, a = 7973, s = e.getBCHDigit(a);
  function l(x, m, $) {
    for (let b = 1; b <= 40; b++)
...
var Bi = {};
const zt = V, Oi = 1335, _n = 21522, pi = zt.getBCHDigit(Oi);
...
var kn = ji.exports;
(function(r) {
  const e = ge, i = En, n = Sn, o = Bn, t = jn, a = ne, s = V, l = kn;
  function h(g) {
...
const _t = V, Tt = Ct, zn = wn, Dn = bn, Nn = Ii, Mn = Ei, Dt = Wi, Nt = $t, Un = vn, lt = Pi, Fn = Bi, Vn = ge, Pt = Ai;
function qn(r, e) {
  ...
  for (let o = 0; o < n.length; o++) {
    ...
    for (let s = -1; s <= 7; s++)
      if (!(t + s <= -1 || i <= t + s))
        for (let l = -1; l <= 7; l++)
          a + l <= -1 || i <= a + l || (s >= 0 && s <= 6 && (l === 0 || l === 6) || l >= 0 && l <= 6 && (s === 0 || s === 6) || s >= 2 && s <= 4 && l >= 2 && l <= 4 ? r.set(t + s, a + l, !0, !0) : r.set(t + s, a + l, !1, !0));
  }
}
function Hn(r) {
  const e = r.size;
...
function Kn(r, e) {
  ...
  for (let n = 0; n < i.length; n++) {
    ...
    for (let a = -2; a <= 2; a++)
      for (let s = -2; s <= 2; s++)
        a === -2 || a === 2 || s === -2 || s === 2 || a === 0 && s === 0 ? r.set(o + a, t + s, !0, !0) : r.set(o + a, t + s, !1, !0);
  }
}
function Gn(r, e) {
  ...
  let o, t, a;
  for (let s = 0; s < 18; s++)
    o = Math.floor(s / 3), t = s % 3 + i - 8 - 3, a = (n >> s & 1) === 1, r.set(o, t, a, !0), r.set(t, o, a, !0);
}
function Lt(r, e, i) {
  const n = r.size, o = Fn.getEncodedBits(e, i);
  let t, a;
  for (t = 0; t < 15; t++)
    a = (o >> t & 1) === 1, t < 6 ? r.set(t, 8, a, !0) : t < 8 ? r.set(t + 1, 8, a, !0) : r.set(n - 15 + t, 8, a, !0), t < 8 ? r.set(8, n - t - 1, a, !0) : t < 9 ? r.set(8, 15 - t - 1 + 1, a, !0) : r.set(8, 15 - t - 1, a, !0);
  r.set(n - 8, 8, 1, !0);
}
function Yn(r, e) {
  const i = r.size;
...
function eo(r, e, i) {
  ...
  for (let s = 0; s < r.length; s++) {
    ...
    !l && !t && (t = !0), r[s] ? (a++, s > 0 && l > 0 && r[s - 1] || (n += t ? Bt("M", l + i, 0.5 + h + i) : Bt("m", o, 0), o = 0, t = !1), l + 1 < e && r[s + 1] || (n += Bt("h", a), a = 0)) : o++;
  }
  return n;
}
...
const no = 0.1, gi = 2.5, ae = 7;
function Ot(r, e, i) {
  return r === e ? !1 : (r - e < 0 ? e - r : r - e) <= i + no;
}
function oo(r, e) {
...
const ro = {
  generate({ uri: r, size: e, logoSize: i, dotColor: n = "#141414" }) {
    ...
    h.forEach(({ x: b, y: R }) => {
      const g = (s.length - ae) * l * b, f = (s.length - ae) * l * R, w = 0.45;
    ...
    s.forEach((b, R) => {
      b.forEach((g, f) => {
        if (s[R][f] && !(R < ae && f < ae || R > s.length - (ae + 1) && f < ae || R < ae && f > s.length - (ae + 1)) && !(R > _ && R < x && f > _ && f < x)) {
    ...
    return m.forEach(([b, R]) => {
      ...
      R.forEach((g) => {
        a.push(Ae`<circle cx=${b} cy=${g} fill=${n} r=${l / gi} />`);
      });
...
let Ft = class extends z {
  constructor() {
    ...
    super(), this.forceUpdate = () => {
      this.requestUpdate();
    }, window.addEventListener("resize", this.forceUpdate), J.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
  ...
  qrCodeTemplate() {
    ...
    return S.setWcLinking(void 0), S.setRecentWallet(this.wallet), c` <wui-qr-code
      size=${e}
...
let wi = class extends I {
  constructor() {
    var e;
    if (super(), this.wallet = (e = O.state.data) == null ? void 0 : e.wallet, !this.wallet)
...
wi = go([
  C("w3m-connecting-wc-unsupported")
], wi);
...
let Vt = class extends z {
  constructor() {
    ...
    this.onConnect = this.onConnectProxy.bind(this), this.secondaryBtnLabel = "Open", this.secondaryLabel = yi.CONNECT_LABELS.MOBILE, this.secondaryBtnIcon = "externalLink", this.updateLoadingState(), this.unsubscribe.push(S.subscribeKey("wcUri", () => {
  ...
  onConnectProxy() {
    ...
    if ((e = this.wallet) != null && e.webapp_link && this.uri)
      try {
        this.error = !1;
        const { webapp_link: i, name: n } = this.wallet, { redirect: o, href: t } = E.formatUniversalUrl(i, this.uri);
        S.setWcLinking({ name: n, href: t }), S.setRecentWallet(this.wallet), E.openHref(o, "_blank");
      } catch {
        this.error = !0;
      }
...
let Se = class extends I {
  constructor() {
    var e;
    super(), this.wallet = (e = O.state.data) == null ? void 0 : e.wallet, this.unsubscribe = [], this.platform = void 0, this.platforms = [], this.isSiwxEnabled = !!Y.state.siwx, this.remoteFeatures = Y.state.remoteFeatures, this.determinePlatforms(), this.initializeConnection(), this.unsubscribe.push(Y.subscribeKey("remoteFeatures", (i) => this.remoteFeatures = i));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  async initializeConnection(e = !1) {
    if (!(this.platform === "browser" || Y.state.manualWCControl && !e))
      try {
        const { wcPairingExpiry: i, status: n } = S.state;
        (e || Y.state.enableEmbedded || E.isPairingExpired(i) || n === "connecting") && (await S.connectWalletConnect(), this.isSiwxEnabled || vi.close());
      } catch (i) {
        J.sendEvent({
          type: "track",
          event: "CONNECT_ERROR",
          properties: { message: (i == null ? void 0 : i.message) ?? "Unknown" }
        }), S.setWcError(!0), Qe.showError(i.message ?? "Connection error"), S.resetWcConnection(), O.goBack();
      }
  }
  determinePlatforms() {
    if (!this.wallet) {
    ...
    if (this.platform)
      return;
    const { mobile_link: e, desktop_link: i, webapp_link: n, injected: o, rdns: t } = this.wallet, a = o == null ? void 0 : o.map(({ injected_id: $ }) => $).filter(Boolean), s = [...t ? [t] : a ?? []], l = Y.state.isUniversalProvider ? !1 : s.length, h = e, d = n, _ = S.checkInstalled(s), x = l && _, m = i && !E.isMobile();
    x && !jt.state.noAdapters && this.platforms.push("browser"), h && this.platforms.push(E.isMobile() ? "mobile" : "qrcode"), d && this.platforms.push("web"), m && this.platforms.push("desktop"), !x && l && !jt.state.noAdapters && this.platforms.push("unsupported"), this.platform = this.platforms[0];
  }
  platformTemplate() {
...
let qt = class extends I {
  constructor() {
    super(...arguments), this.isMobile = E.isMobile();
  }
  render() {
    if (this.isMobile) {
      const { featured: e, recommended: i } = T.state, { customWallets: n } = Y.state, o = ft.getRecentWallets(), t = e.length || i.length || (n == null ? void 0 : n.length) || o.length;
      return c`<wui-flex
        flexDirection="column"
        gap="xs"
        .margin=${["3xs", "s", "s", "s"]}
...
qt = Mi([
  C("w3m-connecting-wc-basic-view")
], qt);
/**
 * @license
...
const At = /* @__PURE__ */ new WeakMap(), ri = Gi(class extends Yi {
  render(r) {
    return li;
  }
  update(r, [e]) {
    var n;
    const i = e !== this.G;
    return i && this.G !== void 0 && this.rt(void 0), (i || this.lt !== this.ct) && (this.G = e, this.ht = (n = r.options) == null ? void 0 : n.host, this.rt(this.ct = r.element)), li;
  }
  rt(r) {
...
let H = class extends I {
  constructor() {
    super(...arguments), this.inputElementRef = oi(), this.size = "md", this.disabled = !1, this.placeholder = "", this.type = "text", this.value = "";
  }
  render() {
...
const $o = Ae`<svg  viewBox="0 0 48 54" fill="none">
  <path
...
let ht = class extends I {
  ...
  shimmerTemplate() {
    return this.type === "network" ? c` <wui-shimmer
          ...
          borderRadius="xs"
        ></wui-shimmer>
        ${$o}` : c`<wui-shimmer width="56px" height="56px" borderRadius="xs"></wui-shimmer>`;
  }
};
ht.styles = [A, M, Ro];
qi([
...
let ye = class extends I {
  ...
  async fetchImageSrc() {
    this.wallet && (this.imageSrc = D.getWalletImage(this.wallet), !this.imageSrc && (this.imageLoading = !0, this.imageSrc = await D.fetchWalletImage(this.wallet.image_id), this.imageLoading = !1));
  }
};
ye.styles = Io;
Ge([
...
let pe = class extends I {
  ...
  async initialFetch() {
    ...
    e && (await T.fetchWalletsByPage({ page: 1 }), await e.animate([{ opacity: 1 }, { opacity: 0 }], {
      duration: 200,
      fill: "forwards",
      easing: "ease"
  ...
  walletsTemplate() {
    var n;
    const e = ((n = this.filteredWallets) == null ? void 0 : n.length) > 0 ? E.uniqueBy([...this.featured, ...this.recommended, ...this.filteredWallets], "id") : E.uniqueBy([...this.featured, ...this.recommended, ...this.wallets], "id");
    return gt.markWalletsAsInstalled(e).map((o) => c`
  ...
  paginationLoaderTemplate() {
    const { wallets: e, recommended: i, featured: n, count: o } = T.state, t = window.innerWidth < 352 ? 3 : 4, a = e.length + i.length;
  ...
  createPaginationObserver() {
    ...
    e && (this.paginationObserver = new IntersectionObserver(([n]) => {
      if (n != null && n.isIntersecting && !this.loading) {
        const { page: o, count: t, wallets: a } = T.state;
        a.length < t && T.fetchWalletsByPage({ page: o + 1 });
      }
...
Be([
  v()
], pe.prototype, "wallets", void 0);
Be([
  v()
], pe.prototype, "recommended", void 0);
Be([
  v()
], pe.prototype, "featured", void 0);
Be([
  v()
], pe.prototype, "filteredWallets", void 0);
pe = Be([
  C("w3m-all-wallets-list")
], pe);
const Wo = P`
  wui-grid,
  wui-loading-spinner,
...
let Te = class extends I {
  ...
  async onSearch() {
    (this.query.trim() !== this.prevQuery.trim() || this.badge !== this.prevBadge) && (this.prevQuery = this.query, this.prevBadge = this.badge, this.loading = !0, await T.searchWallet({ search: this.query, badge: this.badge }), this.loading = !1);
  }
  walletsTemplate() {
    const { search: e } = T.state, i = gt.markWalletsAsInstalled(e);
    return e.length ? c`
      <wui-grid
...
It([
  u()
], Te.prototype, "query", void 0);
It([
  u()
], Te.prototype, "badge", void 0);
Te = It([
...
let pt = class extends I {
  constructor() {
    super(...arguments), this.search = "", this.onDebouncedSearch = E.debounce((e) => {
      this.search = e;
    });
  }
  render() {
  ...
  onClick() {
    ...
    this.badge = "certified", Qe.showSvg("Only WalletConnect certified", {
...
let mi = class extends I {
  constructor() {
    var e;
    super(...arguments), this.wallet = (e = O.state.data) == null ? void 0 : e.wallet;
  }
  render() {
    if (!this.wallet)
  ...
  onChromeStore() {
    var e;
    (e = this.wallet) != null && e.chrome_store && E.openHref(this.wallet.chrome_store, "_blank");
  }
  onAppStore() {
    var e;
    (e = this.wallet) != null && e.app_store && E.openHref(this.wallet.app_store, "_blank");
...
mi = To([
  C("w3m-downloads-view")
], mi);
export {
  pt as W3mAllWalletsView,
  qt as W3mConnectingWcBasicView,
  mi as W3mDownloadsView
};
