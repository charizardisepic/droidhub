import { W as Qt, X as At, Y as mt, Z as Jt, _ as te, $ as ye, a0 as bt, a1 as xe, a2 as G, a3 as Ee, a4 as Be, a5 as ve, a6 as Se } from "./index-D26b8tYY.js";
function Ae(n, e, t, r) {
...
class Oe extends Qt {
  constructor(e, t, r, i) {
    super(), this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.blockLen = e, this.outputLen = t, this.padOffset = r, this.isLE = i, this.buffer = new Uint8Array(e), this.view = At(this.buffer);
  }
  update(e) {
    mt(this), e = Jt(e), te(e);
  ...
  digestInto(e) {
    mt(this), ye(e, this), this.finished = !0;
    const { buffer: t, view: r, blockLen: i, isLE: s } = this;
    let { pos: c } = this;
    t[c++] = 128, bt(this.buffer.subarray(c)), this.padOffset > i - c && (this.process(r, 0), c = 0);
    for (let h = c; h < i; h++)
      t[h] = 0;
    Ae(r, i - 8, BigInt(this.length * 8), s), this.process(r, 0);
    const f = At(e), o = this.outputLen;
    if (o % 4)
...
class He extends Oe {
  ...
  process(e, t) {
    ...
    for (let h = 16; h < 64; h++) {
      const B = tt[h - 15], q = tt[h - 2], _ = G(B, 7) ^ G(B, 18) ^ B >>> 3, p = G(q, 17) ^ G(q, 19) ^ q >>> 10;
      tt[h] = p + tt[h - 7] + _ + tt[h - 16] | 0;
    }
    let { A: r, B: i, C: s, D: c, E: f, F: o, G: l, H: g } = this;
    for (let h = 0; h < 64; h++) {
      const B = G(f, 6) ^ G(f, 11) ^ G(f, 25), q = g + B + Ie(f, o, l) + qe[h] + tt[h] | 0, p = (G(r, 2) ^ G(r, 13) ^ G(r, 22)) + Ne(r, i, s) | 0;
...
), Ue = /* @__PURE__ */ Array.from({ length: 256 }, (n, e) => e.toString(16).padStart(2, "0"));
function ht(n) {
  if (Vt(n), ne)
    return n.toHex();
  let e = "";
...
function re(n) {
  return Vt(n), ee(ht(Uint8Array.from(n).reverse()));
}
function gt(n, e) {
  return yt(n.toString(16).padStart(e * 2, "0"));
}
function oe(n, e) {
...
function _e(n) {
  let e;
  for (e = 0; n > Ct; n >>= Rt, e += 1)
    ;
  return e;
}
const Et = (n) => (Rt << BigInt(n)) - Rt, Nt = (n) => new Uint8Array(n), Kt = (n) => Uint8Array.from(n);
function Re(n, e, t) {
  ...
  let r = Nt(n), i = Nt(n), s = 0;
  const c = () => {
    r.fill(1), i.fill(0), s = 0;
  }, f = (...h) => t(i, r, ...h), o = (h = Nt(0)) => {
    i = f(Kt([0]), h), r = f(), h.length !== 0 && (i = f(Kt([1]), h), r = f());
  }, l = () => {
    if (s++ >= 1e3)
...
const Ze = {
  ...
  stringOrUint8Array: (n) => typeof n == "string" || wt(n),
...
class ie extends Qt {
  ...
  digestInto(e) {
    mt(this), te(e, this.outputLen), this.finished = !0, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
...
const se = (n, e, t) => new ie(n, e).update(t).digest();
se.create = (n, e) => new ie(n, e);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Y = BigInt(0), C = BigInt(1), rt = /* @__PURE__ */ BigInt(2), Te = /* @__PURE__ */ BigInt(3), ce = /* @__PURE__ */ BigInt(4), fe = /* @__PURE__ */ BigInt(5), ae = /* @__PURE__ */ BigInt(8);
function M(n, e) {
  const t = n % e;
  return t >= Y ? t : e + t;
}
...
function ue(n, e) {
  const t = (n.ORDER + C) / ce, r = n.pow(e, t);
  if (!n.eql(n.sqr(r), e))
    throw new Error("Cannot find square root");
  return r;
}
function ke(n, e) {
  const t = (n.ORDER - fe) / ae, r = n.mul(e, rt), i = n.pow(r, t), s = n.mul(e, i), c = n.mul(n.mul(s, rt), i), f = n.mul(s, n.sub(c, n.ONE));
  if (!n.eql(n.sqr(f), e))
    throw new Error("Cannot find square root");
  return f;
}
  ...
  return function(o, l) {
    ...
    for (; !o.eql(B, o.ONE); ) {
      ...
      for (; !o.eql(p, o.ONE); )
        if (_++, p = o.sqr(p), _ === g)
          throw new Error("Cannot find square root");
      const k = C << BigInt(g - _ - 1), R = o.pow(h, k);
...
function Ce(n) {
  return n % ce === Te ? ue : n % ae === fe ? ke : ze(n);
}
const Ve = [
  "create",
  "isValid",
...
function Me(n) {
  const e = {
    ...
    BYTES: "isSafeInteger",
    BITS: "isSafeInteger"
  }, t = Ve.reduce((r, i) => (r[i] = "function", r), e);
  return Bt(n, t);
}
function Ye(n, e, t) {
  if (t < Y)
...
function Dt(n, e) {
  const t = (n.ORDER - C) / rt, r = n.pow(e, t), i = n.eql(r, n.ONE), s = n.eql(r, n.ZERO), c = n.eql(r, n.neg(n.ONE));
  if (!i && !s && !c)
...
function Yt(n, e, t = !1, r = {}) {
  if (n <= Y)
    throw new Error("invalid field: expected ORDER > 0, got " + n);
  const { nBitLength: i, nByteLength: s } = de(n, e);
  if (s > 2048)
  ...
  const f = Object.freeze({
    ...
    mulN: (o, l) => o * l,
    inv: (o) => Zt(o, n),
    sqrt: r.sqrt || ((o) => (c || (c = Ce(n)), c(f, o))),
    toBytes: (o) => t ? oe(o, s) : gt(o, s),
    fromBytes: (o) => {
      if (o.length !== s)
...
function je(n, e, t = !1) {
  const r = n.length, i = he(e), s = we(e);
  if (r < 16 || r < s || r > 1024)
    throw new Error("expected " + s + "-1024 bytes of input, got " + r);
  const c = t ? re(n) : ot(n), f = M(c, e - C) + C;
  return t ? oe(f, i) : gt(f, i);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Gt = BigInt(0), Tt = BigInt(1);
function Ot(n, e) {
  const t = e.negate();
  return n ? t : e;
}
...
function qt(n, e) {
  ge(n, e);
  const t = Math.ceil(e / n) + 1, r = 2 ** (n - 1), i = 2 ** n, s = Et(n), c = BigInt(n);
...
const Ht = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap();
function Lt(n) {
  return pe.get(n) || 1;
}
function De(n, e) {
  return {
    ...
    unsafeLadder(t, r, i = n.ZERO) {
      let s = t;
      for (; r > Gt; )
        r & Tt && (i = i.add(s)), s = s.double(), r >>= Tt;
      return i;
    },
    /**
    ...
    precomputeWindow(t, r) {
      const { windows: i, windowSize: s } = qt(r, e), c = [];
      let f = t, o = f;
      for (let l = 0; l < i; l++) {
        o = f, c.push(o);
        for (let g = 1; g < s; g++)
    ...
    wNAF(t, r, i) {
      ...
      for (let o = 0; o < f.windows; o++) {
        const { nextN: l, offset: g, isZero: h, isNeg: B, isNegF: q, offsetF: _ } = Wt(i, o, f);
        i = l, h ? c = c.add(Ot(q, r[_])) : s = s.add(Ot(B, r[g]));
      }
      return { p: s, f: c };
    },
    /**
    ...
    wNAFUnsafe(t, r, i, s = n.ZERO) {
      const c = qt(t, e);
      for (let f = 0; f < c.windows && i !== Gt; f++) {
        const { nextN: o, offset: l, isZero: g, isNeg: h } = Wt(i, f, c);
        if (i = o, !g) {
          const B = r[l];
    ...
    getPrecomputes(t, r, i) {
      let s = Ht.get(r);
      return s || (s = this.precomputeWindow(r, t), t !== 1 && Ht.set(r, i(s))), s;
    },
    wNAFCached(t, r, i) {
      const s = Lt(t);
...
function Ge(n, e, t, r) {
  ...
  const c = n.ZERO, f = _e(BigInt(i));
  let o = 1;
  f > 12 ? o = f - 3 : f > 4 ? o = f - 2 : f > 0 && (o = 2);
  const l = Et(o), g = new Array(Number(l) + 1).fill(c), h = Math.floor((e.BITS - 1) / o) * o;
  let B = c;
  for (let q = h; q >= 0; q -= o) {
    g.fill(c);
    for (let p = 0; p < s; p++) {
...
const F = {
  ...
  _tlv: {
    encode: (n, e) => {
      ...
      const r = e.length / 2, i = pt(r);
      if (i.length / 2 & 128)
        throw new t("tlv.encode: long form length too big");
      const s = r > 127 ? pt(i.length / 2 | 128) : "";
      return pt(n) + s + i + e;
    },
  ...
  toSig(n) {
    const { Err: e, _int: t, _tlv: r } = F, i = K("signature", n), { v: s, l: c } = r.decode(48, i);
    if (c.length)
  ...
  hexFromSig(n) {
    const { _tlv: e, _int: t } = F, r = e.encode(2, t.encode(n.r)), i = e.encode(2, t.encode(n.s)), s = r + i;
...
const X = BigInt(0), Z = BigInt(1);
BigInt(2);
const _t = BigInt(3), Fe = BigInt(4);
function Xe(n) {
  const e = We(n), { Fp: t } = e, r = Yt(e.n, e.nBitLength), i = e.toBytes || ((A, a, w) => {
    const b = a.toAffine();
    return xt(Uint8Array.from([4]), t.toBytes(b.x), t.toBytes(b.y));
  }), s = e.fromBytes || ((A) => {
  ...
  const o = t.mul(t.pow(e.a, _t), Fe), l = t.mul(t.sqr(e.b), BigInt(27));
  if (t.is0(t.add(o, l)))
  ...
  function h(A) {
    ...
    if (a && typeof A != "bigint") {
      if (wt(A) && (A = ht(A)), typeof A != "string" || !a.includes(A.length))
        throw new Error("invalid private key");
      A = A.padStart(w * 2, "0");
    }
    let O;
    try {
      O = typeof A == "bigint" ? A : ot(K("private key", A, w));
    } catch {
      throw new Error("invalid private key, expected hex or " + w + " bytes, got " + typeof A);
    }
    return b && (O = M(O, v)), ft("private key", O, Z, v), O;
  }
  function B(A) {
    if (!(A instanceof p))
  ...
  class p {
     ...
     */
    static fromHex(a) {
      const w = p.fromAffine(s(K("pointHex", a)));
    ...
    double() {
      const { a, b: w } = e, b = t.mul(w, _t), { px: v, py: O, pz: L } = this;
    ...
    multiplyUnsafe(a) {
      ...
      for (; L > X || y > X; )
        L & Z && (N = N.add(T)), y & Z && (x = x.add(T)), T = T.double(), L >>= Z, y >>= Z;
    ...
    multiplyAndAddUnsafe(a, w, b) {
      const v = p.BASE, O = (H, y) => y === X || y === Z || !H.equals(v) ? H.multiplyUnsafe(y) : H.multiply(y), L = O(this, w).add(O(a, b));
    ...
    clearCofactor() {
      ...
      return a === Z ? this : w ? w(p, this) : this.multiplyUnsafe(e.h);
    }
    toRawBytes(a = !0) {
      return dt("isCompressed", a), this.assertValidity(), i(p, this, a);
    }
    toHex(a = !0) {
  ...
  const { endo: k, nBitLength: R } = e, D = De(p, k ? Math.ceil(R / 2) : R);
  return {
    CURVE: e,
    ProjectivePoint: p,
...
function Je(n) {
  const e = Qe(n), { Fp: t, n: r, nByteLength: i, nBitLength: s } = e, c = t.BYTES + 1, f = 2 * t.BYTES + 1;
  function o(d) {
    return M(d, r);
  }
  function l(d) {
  ...
  const { ProjectivePoint: g, normPrivateKeyToScalar: h, weierstrassEquation: B, isWithinCurveOrder: q } = Xe({
    ...e,
    toBytes(d, u, m) {
      const I = u.toAffine(), E = t.toBytes(I.x), S = xt;
      return dt("isCompressed", m), m ? S(Uint8Array.from([u.hasEvenY() ? 2 : 3]), E) : S(Uint8Array.from([4]), E, t.toBytes(I.y));
    },
    fromBytes(d) {
  ...
  const k = (d, u, m) => ot(d.slice(u, m));
  class R {
    constructor(u, m, I) {
      ft("r", u, Z, r), ft("s", m, Z, r), this.r = u, this.s = m, I != null && (this.recovery = I), Object.freeze(this);
    }
    // pair (bytes of r, bytes of s)
    static fromCompact(u) {
      const m = i;
      return u = K("compactSignature", u, m * 2), new R(k(u, 0, m), k(u, m, 2 * m));
    }
    // DER encoded ECDSA signature
    // https://bitcoin.stackexchange.com/questions/57644/what-are-the-parts-of-a-bitcoin-transaction-input-script
    static fromDER(u) {
      const { r: m, s: I } = F.toSig(K("DER", u));
      return new R(m, I);
    }
    /**
     * @todo remove
    ...
    recoverPublicKey(u) {
      const { r: m, s: I, recovery: E } = this, S = v(K("msgHash", u));
      if (E == null || ![0, 1, 2, 3].includes(E))
        throw new Error("recovery id invalid");
      const U = E === 2 || E === 3 ? m + e.n : m;
      if (U >= t.ORDER)
        throw new Error("recovery id 2 or 3 invalid");
      const z = E & 1 ? "03" : "02", W = g.fromHex(z + Ut(U, t.BYTES)), P = l(U), V = o(-S * P), it = o(I * P), Q = g.BASE.multiplyAndAddUnsafe(W, V, it);
      if (!Q)
    ...
    toCompactHex() {
      const u = i;
      return Ut(this.r, u) + Ut(this.s, u);
    }
  }
  const D = {
    isValidPrivateKey(d) {
  ...
  function a(d) {
    ...
    if (d instanceof g)
      return !0;
    const m = K("key", d).length, I = t.BYTES, E = I + 1, S = 2 * I + 1;
  ...
  const b = e.bits2int || function(d) {
    ...
    const u = ot(d), m = d.length * 8 - s;
    return m > 0 ? u >> BigInt(m) : u;
  }, v = e.bits2int_modN || function(d) {
    return o(b(d));
  }, O = Et(s);
  function L(d) {
    return ft("num < 2^" + s, d, X, O), gt(d, i);
  }
  function H(d, u, m = y) {
    ...
    S == null && (S = !0), d = K("msgHash", d), $t(m), U && (d = K("prehashed msgHash", I(d)));
    const W = v(d), P = h(u), V = [L(P), L(W)];
    if (z != null && z !== !1) {
      const et = z === !0 ? E(t.BYTES) : z;
      V.push(K("extraEntropy", et));
    }
    const it = xt(...V), Q = W;
    function vt(et) {
      const st = b(et);
      ...
      if (ut === X)
        return;
      let lt = (at.x === nt ? 0 : 2) | Number(at.y & Z), ct = ut;
      return S && _(ut) && (ct = p(ut), lt ^= 1), new R(nt, ct, lt);
    }
    return { seed: it, k2sig: vt };
  }
  const y = { lowS: e.lowS, prehash: !1 }, N = { lowS: e.lowS, prehash: !1 };
  function x(d, u, m = y) {
    const { seed: I, k2sig: E } = H(d, u, m), S = e;
    return Re(S.hash.outputLen, S.nByteLength, S.hmac)(I, E);
  }
  g.BASE._setWindowSize(8);
  function T(d, u, m, I = N) {
    var lt;
    const E = d;
    u = K("msgHash", u), m = K("publicKey", m);
    const { lowS: S, prehash: U, format: z } = I;
    if ($t(I), "strict" in I)
      throw new Error("options.strict was renamed to lowS");
    if (z !== void 0 && z !== "compact" && z !== "der")
      throw new Error("format must be compact or der");
    const W = typeof E == "string" || wt(E), P = !W && !z && typeof E == "object" && E !== null && typeof E.r == "bigint" && typeof E.s == "bigint";
    if (!W && !P)
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const be = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), Ft = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), nn = BigInt(0), rn = BigInt(1), kt = BigInt(2), Xt = (n, e) => (n + e / kt) / e;
function on(n) {
  const e = be, t = BigInt(3), r = BigInt(6), i = BigInt(11), s = BigInt(22), c = BigInt(23), f = BigInt(44), o = BigInt(88), l = n * n * n % e, g = l * l * n % e, h = j(g, t, e) * g % e, B = j(h, t, e) * g % e, q = j(B, kt, e) * l % e, _ = j(q, i, e) * q % e, p = j(_, s, e) * _ % e, k = j(p, f, e) * p % e, R = j(k, o, e) * k % e, D = j(R, f, e) * p % e, A = j(D, t, e) * g % e, a = j(A, c, e) * _ % e, w = j(a, r, e) * l % e, b = j(w, kt, e);
  if (!zt.eql(zt.sqr(b), n))
    throw new Error("Cannot find square root");
  return b;
}
const zt = Yt(be, void 0, void 0, { sqrt: on }), cn = en({
  a: nn,
  b: BigInt(7),
  Fp: zt,
  n: Ft,
  ...
  endo: {
    ...
    splitScalar: (n) => {
      const e = Ft, t = BigInt("0x3086d221a7d46bcde86c90e49284eb15"), r = -rn * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"), i = BigInt("0x114ca50f7a8e2f3f657c1108d9d44cfd8"), s = t, c = BigInt("0x100000000000000000000000000000000"), f = Xt(s * n, e), o = Xt(-r * n, e);
      let l = M(n - f * t - o * i, e), g = M(-f * r - o * s, e);
      const h = l > c, B = g > c;
