import { H as Qt, G as Nt, I as Et, J as Jt, K as de, L as he, N as P, P as ge, Q as we, U as pe, V as be } from "./core-DT8g9mFm.js";
function ye(n, e, t, r) {
...
function Ye(n, e, t = !1) {
  ...
  const c = t ? Vt(n) : rt(n), f = M(c, e - T) + T;
...
const Zt = ie(le, void 0, void 0, { sqrt: on }), sn = nn({
  ...
  endo: {
    ...
    splitScalar: (n) => {
      ...
      let u = M(n - f * t - i * o, e), y = M(-f * r - i * s, e);
      const h = u > c, l = y > c;
